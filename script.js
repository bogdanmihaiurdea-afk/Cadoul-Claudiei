...
const bazaDateDestinatii = {
    ...
    "L": ["Letonia", "Lituania", "Ljubljana", "Liban", "Laos"],
    "I": ["Iran", "Islanda", "Irlanda", "Indonezia", "India"],
    "N": ["Norvegia", "Namibia", "Nepal", "Nicaragua", "Noua Zeelandă"],
    "O": ["Oman", "Osaka", "Ouarzazate", "Ontario", "Oslo"],
    "T": ["Tokio", "Tenerife", "Tunisia", "Taiwan", "Tanzania"]
};
